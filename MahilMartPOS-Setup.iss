...
#define MyAppURL ""
#define MyAppExeName "start_mahilmart.bat"
...
[Files]
Source: "{#SourceDir}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: ".git*;__pycache__\*;*.pyc;*.pyo;*.iss;installer\output\*"
